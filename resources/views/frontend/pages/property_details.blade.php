                ...
                <div class=" col-xl-12">
                    ...
                    <div id="testimonial-slider" class="owl-carousel">
                        <div class="testimonial">
                            <div class="pic">
                                <img src="assets/images/property_details_img_1.jpg" alt="img" class="img-fluid w-100">
                            </div>
                        </div>
                        <div class="testimonial">
                            <div class="pic">
                                <img src="assets/images/property_details_img_2.jpg" alt="img" class="img-fluid w-100">

                            </div>
                        </div>
                        <div class="testimonial">
                            <div class="pic">
                                <img src="assets/images/property_details_img_3.jpg" alt="img" class="img-fluid w-100">
                            </div>
                        </div>
                        <div class="testimonial">
                            <div class="pic">
                                <img src="assets/images/property_details_img_4.jpg" alt="img" class="img-fluid w-100">
                            </div>
                        </div>
                    </div>
                </div>
