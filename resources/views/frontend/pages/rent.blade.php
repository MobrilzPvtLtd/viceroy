    ...
    <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
            ...
            <div class="container ">
                <div class="row mt_95 xs_mt_75  ">
                        ...
                        <div class="row" id="lits-item">
                            @if (count($propertys) > 0)
                                @foreach ($propertys as $property)
                                    <div class="col-xl-5 col-md-5 wow fadeInUp" data-wow-duration="1.5s">
                                                ...
                                                <div class="single_property_top">
                                                    ...
                                                    <div class="wish001">
                                                        ...
                                                        <button id="addtocart-{{ $property->id }}" type="submit"
                                                            onclick="addToCartOrRemove({{ $property->id }})"class="addToCart btn btn-primary"><i
                                                    ...
                                                    <ul class="d-flex flex-wrap">
                                                        <li> <span><img src="assets/images/bad.png" alt="img"
                                                        ...
                                                        <li><span><img src="assets/images/squre.png" alt="img"
                                                                    class="img-fluid w-100" /></span>
                    ...
                    <div class="col-md-6 text-end   mt_95 xs_mt_75" id="map001">
                        <div id="mapCanvas" style="height: 700px; width:100%;"></div>
                    </div>
