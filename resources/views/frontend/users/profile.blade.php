...
@section('content')
    <div class="profile-container">
        <div class="profile-header">
            <img class="mx-auto -mb-24  w-50 rounded-lg object-cover" src="{{ asset('public/storage/' . $$module_name_singular->avatar) }}"
            ...
            @if ($$module_name_singular->url_website)
                <a href="{{ $$module_name_singular->url_website }}" target="_blank"
                    class="profile-website">{{ $$module_name_singular->url_website }}</a>
            @endif
        </div>
        <div class="profile-social-links">
            ...
            @if ($$module_name_singular->url_instagram)
                <a href="{{ $$module_name_singular->url_instagram }}" target="_blank">
                    <svg class="bi bi-instagram" xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                        fill="currentColor" viewBox="0 0 16 16">
                        <path
            ...
            @auth
                @if (auth()->user()->id == $$module_name_singular->id)
                    ...
                    {{-- <div class="info-item">
                        ...
                        <span
                            class="info-value">{{ optional($$module_name_singular->$field_name)->toFormattedDateString() }}</span>
                    </div> --}}
                    {{-- <div class="info-item">
